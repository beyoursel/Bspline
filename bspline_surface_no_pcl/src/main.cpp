...
int main(int argc, char **argv) {
  ...
  // std::string out_bspline_folder = "/media/taole/ssd1/letaotao/develop/Bspline/bspline_surface_no_pcl";
  // std::string output_bspline_file = out_bspline_folder + "/" + "simple_bspline_hill" + ".pcd";  
  // pcl::io::savePCDFileBinary(output_bspline_file, *ctr_cloud);

  VisualizePointCloudV2(cloud, ctr_cloud, surf_cloud);
